...
//         // Use Firebase Authentication API to send the OTP
//         await admin.auth().sendPhoneVerificationCode(phoneNumber, null);
...
//     if (![Number, pass, idType].every((field) => field && field.trim())) {
